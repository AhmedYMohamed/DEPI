...
echo ""
echo "📝 Test commands:"
echo "   ~/test_hive_local.sh - Test Hive local mode"
echo ""
echo "🔧 Manual commands:"
echo "   Hive: hive"
echo "   Spark: pyspark, spark-shell, or spark-sql"
echo "   Kafka: kafka-topics.sh --list --bootstrap-server localhost:9092"
echo ""
echo "📂 Data locations:"
echo "   Hive warehouse: /opt/hive/warehouse/"
echo "   Hive metastore: /opt/hive/metastore_db/"
echo ""
echo "⚠️  Note: In Codespaces, web UIs require port forwarding in VS Code"